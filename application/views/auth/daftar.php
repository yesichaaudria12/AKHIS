						...
						<div class="border p-4 rounded">
							...
							<div class="form-body">
								<form action="<?= base_url('auth/daftar'); ?>" method="POST" class="row g-3">
									...
									<input type="text" class="form-control mt-0" id="nama_lengkap" name="nama_lengkap"
									...
									<input type="email" class="form-control mt-0" id="email" name="email"
										value="<?= set_value('email'); ?>" placeholder="Masukan Email Valid">
									...
									<div class="input-group mt-0" id="show_hide_password">
										<input type="password" class="form-control border-end-0"
											...
											placeholder="Masukan Konfirmasi Password"> <a href="javascript:;"
											class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
									</div>
