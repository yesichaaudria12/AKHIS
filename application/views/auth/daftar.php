...
<html lang="en">
    <head>
        ...
        <script src="<?= base_url('assets'); ?>/icon/font-awesome/css/all.css" crossorigin="anonymous"></script>
    </head>
    <body class="bg-primary">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url(current_url()); ?>" method="post">
                                            <div class="row mb-3">
                                                <div class="col">
        ...
        <script src="<?= base_url('assets'); ?>/vendor/bootstrap-5/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
        <!-- JS Sb-Admin -->
